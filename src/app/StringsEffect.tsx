...
import "./StringsEffect.scss";

/**
 * StringsEffect adapted for React
 * nCreated Date / July 11, 2020\nAuthor / Toshiya Marukubo\nTwitter / https://twitter.com/toshiyamarukubo
 */
export default function StringsEffect() {
  ...
  useEffect(() => {
    ...
    var X = (canvas.width = 282);
    var Y = (canvas.height = 282);
    var mouseX = null;
    var mouseY = null;
    var dist = 80;
  ...
  return <canvas ref={canvasRef} id="strings-effect"></canvas>;
}
